...
private static ConSalas instanciass;
    public ConSalas() {
        initComponents();
    ...
    public static ConSalas getInstancia(){
        if (instanciass == null){
            instanciass = new ConSalas();
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Consulta de Sala");
